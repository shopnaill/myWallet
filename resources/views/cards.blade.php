    ...
    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
        <div class="card mb-3 border-0 rounded-0 gradient-danger">
            <div class="card-body">
                <div class="media">
                    <div class="media-body">
                        <h2 class="f-light">{{$my_balance}}</h2>
        ...
        <div class="card mb-3 border-0 rounded-0 bg-success">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span class="dynamicsparkline2"><canvas width="90" height="20" style="display: inline-block; width: 90px; height: 20px; vertical-align: top;"></canvas></span>
                    </div>
                </div>
        ...
        <div class="card mb-3 border-0 rounded-0 bg-danger">
            ...
            <div class="card-body">
                <div class="media mb-2">
                    <div class="media-body">
                        <h4>385155</h4>
                        <p class="text-uppercase">Expenses</p>
                    </div>
        ...
        <div class="card mb-3 border-0 rounded-0 bg-warning">
            ...
            <div class="card-body">
                <div class="media mb-2">
                    <div class="media-body">
                        <h4>12345</h4>
                        <p class="text-uppercase">Savings</p>
                    </div>
